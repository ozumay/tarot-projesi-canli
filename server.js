...
const cors = require('cors'); // Gerekli olabilir, ekleyelim.

const PORT = 3000;

app.use(express.static('public')); 
app.use(bodyParser.json()); 
app.use(cors()); // CORS ekledik.
...
// ----------------------------------------------------
// VERİTABANI VE YÖNETİCİ BİLGİLERİ (Değişmedi)
...
// person_rep (KİŞİ) ve role (ROL) yerleri değiştirildi, emotion (DUYGU) eklendi.
const TAROT_CARD_DATA = [
    // ID 1: DELİ (The Fool)
    {
        ...
        upright: {
            ...
            role: "Yolcu, Ruhsal Maceracı", // Eski person_rep
            emotion: "Coşku, Merak, İyimserlik", // YENİ ALAN
            ...
            person_rep: "Çocuk, Özgür Ruhlu Birey, Yeni İş Arkadaşı", // YENİ KİŞİ
        ...
        reversed: {
            ...
            emotion: "Korku, Kararsızlık, Engellenmişlik", // YENİ ALAN
    ...
    // ID 2: BÜYÜCÜ (The Magician)
    {
        ...
        upright: {
            ...
            emotion: "Özgüven, Azim, Odaklanma", // YENİ ALAN
            ...
            person_rep: "Patron, Girişimci, Avukat, İş Arkadaşı", // YENİ KİŞİ
        ...
        reversed: {
            ...
            emotion: "Şüphe, Güvensizlik, Kontrol Kaybı", // YENİ ALAN
    ...
    // ID 3: BAŞRAHİBE (The High Priestess)
    {
        ...
        upright: {
            ...
            emotion: "Huzur, Sezgisellik, Sakinlik", // YENİ ALAN
            ...
            person_rep: "Bilge Anne, Sırdaş, Psikolog, Abla/Kız Kardeş", // YENİ KİŞİ
        ...
        reversed: {
            ...
            emotion: "Kafa Karışıklığı, Pasiflik, Şüphe", // YENİ ALAN
    ...
    // ID 4: İMPARATORİÇE (The Empress)
    {
        ...
        upright: {
            ...
            emotion: "Sevgi, Bolluk Hissi, Yaratıcılık", // YENİ ALAN
            ...
            person_rep: "Anne, Hamile Arkadaş, Besleyici Partner, Girişimci Kadın", // YENİ KİŞİ
        ...
        reversed: {
            ...
            emotion: "Kısıtlama, Bağımlılık, Verimsizlik", // YENİ ALAN
    ...
    // ID 5: İMPARATOR (The Emperor)
    {
        ...
        upright: {
            ...
            emotion: "Güven, İstikrar, Hükmetme Hissi", // YENİ ALAN
            situation: "Yönetim, Yapı Oluşturma, Mantıklı Karar Alma",
            number_rep: "IV (4) / Yapı, Düzen", 
            archetype: "Liderlik", 
            energy: "Verici (Yang), Güçlü",
            person_rep: "Baba, Patron, Amir, Hükümet Yetkilisi", // YENİ KİŞİ
        ...
        reversed: {
            ...
            emotion: "Öfke, Kontrolsüzlük, Yetersizlik", // YENİ ALAN
    ...
    // ID 6: BAŞPAPAZ (The Hierophant)
    {
        ...
        upright: {
            ...
            emotion: "Saygı, İnanç, Güven", // YENİ ALAN
            situation: "Eğitim, Manevi Öğrenme, Rehberlik Alma",
            number_rep: "V (5) / Gelenek, Bilgi", 
            archetype: "Gelenek", 
            energy: "Alıcı (Yin)",
            person_rep: "Öğretmen, Mentor, Din Adamı, Ahlaklı Danışman", // YENİ KİŞİ
        ...
        reversed: {
            ...
            role: "Asi, Yalancı",
            emotion: "İsyan, Hayal Kırıklığı, Şüphe", // YENİ ALAN
            situation: "Yanlış Yönlendirme, Dogmatik Tutum",
    ...
    // ID 7: AŞIKLAR (The Lovers)
    {
        ...
        upright: {
            ...
            emotion: "Sevgi, Uyum, Bağlılık", // YENİ ALAN
            ...
            person_rep: "Partner, Sevgili, Yakın Arkadaş, İş Ortağı", // YENİ KİŞİ
        ...
        reversed: {
            ...
            emotion: "Kararsızlık, Kayıp, Uyumsuzluk", // YENİ ALAN
    ...
    // ID 8: SAVAŞ ARABASI (The Chariot)
    {
        ...
        upright: {
            ...
            emotion: "Kararlılık, Kontrol, Zafer Hissi", // YENİ ALAN
            ...
            person_rep: "Kararlı Lider, Disiplinli Çalışan, Başarılı Sporcu", // YENİ KİŞİ
        ...
        reversed: {
            ...
            emotion: "Kontrol Kaybı, Hüsran, Dağınıklık", // YENİ ALAN
    ...
    // ID 9: GÜÇ (Strength)
    {
        ...
        upright: {
            ...
            emotion: "Cesaret, Şefkat, İçsel Denge", // YENİ ALAN
            ...
            person_rep: "Merhametli Patron, İradesi Güçlü Birey, Cesur Yakın Arkadaş", // YENİ KİŞİ
        ...
        reversed: {
            ...
            emotion: "Korku, Öfke, Sabırsızlık", // YENİ ALAN
    ...
    // ID 10: MÜNZEVİ (The Hermit)
    {
        ...
        upright: {
            ...
            emotion: "Huzur, Bilgelik, Düşüncelilik", // YENİ ALAN
            situation: "Ruhsal Arayış, İç Sesle İletişim, Yalnız Düşünme",
            number_rep: "IX (9) / Bilgelik, Yalnızlık", 
            archetype: "İç Gözlem", 
            energy: "Alıcı (Yin), Sessiz",
            person_rep: "Filozof, Düşünceli Amca, Ruhani Rehber", // YENİ KİŞİ
        ...
        reversed: {
            ...
            role: "İzole, Karamsar",
            emotion: "Yalnızlık, İzolasyon, Karamsarlık", // YENİ ALAN
    ...
    // ID 11: KADER ÇARKI (The Wheel of Fortune)
    {
        ...
        reversed: {
            ...
            emotion: "Kontrolsüzlük, Şanssızlık, Hayal Kırıklığı", // YENİ ALAN
            ...
            person_rep: "Esnek Olmayan Patron, Değişimle Başa Çıkamayan Akraba", // YENİ KİŞİ
    ...
    // ID 12: ADALET (Justice)
    {
        ...
        upright: {
            ...
            emotion: "Objektiflik, Sorumluluk, Denge", // YENİ ALAN
            ...
            person_rep: "Avukat, Hukukçu, Yargıç, Adil Arkadaş", // YENİ KİŞİ
    ...
    // ID 13: ASILAN ADAM (The Hanged Man)
    {
        ...
        reversed: {
            ...
            emotion: "Sabırsızlık, Direnç, Acele", // YENİ ALAN
            situation: "Sabırsızlık, Yanlış Değerlendirme",
            number_rep: "XII (12) / Direnç", archetype: "Sabırsızlık", energy: "Dengesiz Yin, Acelecilik",
            person_rep: "Sabırsız Erkek Kardeş, Dirençli Patron", // YENİ KİŞİ
    ...
    // ID 14: ÖLÜM (Death)
    {
        ...
        upright: {
            ...
            emotion: "Kabul, Özgürleşme, Huzur", // YENİ ALAN
            situation: "Hayat Döngüsünde Değişim, Sonlar ve Yeni Başlangıçlar",
            number_rep: "XIII (13) / Dönüşüm", archetype: "Yeniden Doğuş", energy: "Alıcı (Yin), Derin Enerji",
            person_rep: "Değişimi Kabul Eden, Hayat Döngüsünü Bitiren Birey", // YENİ KİŞİ
        ...
        reversed: {
            ...
            emotion: "Korku, Direnç, Tıkanıklık", // YENİ ALAN
            situation: "Dirençli Değişimler, Dönüşümü Geciktirme",
            number_rep: "XIII (13) / Direnç", archetype: "Dönüşüm Korkusu", energy: "Dengesiz Yin, Dirençli",
            person_rep: "Eski Alışkanlıklara Bağlı Ebeveyn, Değişime Kapalı İş Arkadaşı", // YENİ KİŞİ
    ...
    // ID 15: DENGE (Temperance)
    {
        ...
        upright: {
            ...
            emotion: "Huzur, Ölçülülük, Uyum", // YENİ ALAN
            situation: "Denge Arayışı, Sabır Gerektiren Süreçler",
            number_rep: "XIV (14) / Uyum, Ölçülülük", archetype: "Bütünleşme", energy: "Alıcı-Verici (Yin-Yang), Uyumlu",
            person_rep: "Arabulucu, Sabırlı Arkadaş, Ölçülü Yönetici", // YENİ KİŞİ
            astrology: "Yay burcu (Genişleme, Optimizm)"
        },
        reversed: {
            positive: "Dengesizliği Fark Etme, Uyum Sağlama Fırsatı", negative: "Aşırılık, Sabırsızlık, Çatışmalar",
            role: "Uyum Sağlayamayan, Aşırı Tepki Veren",
            emotion: "Sabırsızlık, Aşırılık, Çatışma", // YENİ ALAN
            situation: "Dengesiz İlişkiler, Uyumsuz Süreçler",
            number_rep: "XIV (14) / Dengesizlik", archetype: "Aşırılık", energy: "Dengesiz Yin-Yang",
            person_rep: "Uyum Sağlayamayan Partner, Sabırsız Patron", // YENİ KİŞİ
    ...
    // ID 16: ŞEYTAN (The Devil)
    {
        ...
        upright: {
            ...
            emotion: "Arzu, Kısıtlama, Utanç", // YENİ ALAN
            situation: "Bağımlılık Krizleri, Arzuların Güçlenmesi",
            number_rep: "XV (15) / Bağımlılık, Arzu", archetype: "Gölge Benlik", energy: "Verici (Yang), Yoğun Arzu",
            person_rep: "Bağımlı Akraba, Kontrolcü Partner, Saplantılı Düşman", // YENİ KİŞİ
        ...
        reversed: {
            ...
            emotion: "Özgürleşme, Bilinç, Güç", // YENİ ALAN
            situation: "Özgürleşme Süreçleri, Kontrol Kazanma",
            number_rep: "XV (15) / Özgürleşme", archetype: "Bilinçli Seçim", energy: "Dengesiz Yang, Serbestleşme",
            person_rep: "Özgürleşmiş Birey, Kontrolü Kazanmış Akraba", // YENİ KİŞİ
    ...
    // ID 17: KULE (The Tower)
    {
        ...
        upright: {
            ...
            emotion: "Şok, Korku, Farkındalık", // YENİ ALAN
            situation: "Beklenmedik Değişimler, Eski Düzenin Çöküşü",
            number_rep: "XVI (16) / Yıkım, Kriz", archetype: "Ani Değişim", energy: "Verici (Yang), Yıkıcı",
            person_rep: "Değişime Zorlanan, Uyanışa Açık Birey, Sarsıcı Olay Yaratıcısı", // YENİ KİŞİ
        ...
        reversed: {
            ...
            emotion: "Direnç, Tıkanıklık, Korku", // YENİ ALAN
            situation: "Krizlerin Ertelenmesi, Engellenmiş Uyanış",
            number_rep: "XVI (16) / Önleme", archetype: "Direnç", energy: "Dengesiz Yang, Denge Arayışı",
            person_rep: "Kontrollü, Değişimle Temkinli Başa Çıkan Akraba", // YENİ KİŞİ
    ...
    // ID 18: YILDIZ (The Star)
    {
        ...
        upright: {
            ...
            emotion: "Umut, İlham, Huzur", // YENİ ALAN
            situation: "İyileşme, Umut, Yeni Fırsatlar",
            number_rep: "XVII (17) / Umut, İlham", archetype: "Ruhsal İyileşme", energy: "Alıcı (Yin), Sakin",
            person_rep: "Pozitif Arkadaş, İyileştirici, Ruhsal Öğretmen", // YENİ KİŞİ
        ...
        reversed: {
            ...
            emotion: "Umutsuzluk, Karamsarlık, Motivasyon Kaybı", // YENİ ALAN
            situation: "Karamsarlık, İlham Eksikliği",
            number_rep: "XVII (17) / Motivasyon Kaybı", archetype: "Umutsuzluk", energy: "Dengesiz Yin, Karamsar",
            person_rep: "Umutsuz, Rehbersiz, Karamsar İş Arkadaşı", // YENİ KİŞİ
            astrology: "Kova burcunun Gölgesi"
        }
    },
    // ID 19: AY (The Moon)
    {
        ...
        upright: {
            ...
            emotion: "Sezgi, Belirsizlik, Gizem", // YENİ ALAN
            situation: "Sezgisel Deneyimler, Gizemli Durumlar",
            number_rep: "XVIII (18) / Bilinçaltı, Gizem", archetype: "İllüzyon", energy: "Alıcı (Yin), Sezgisel",
            person_rep: "Sezgisel Birey, Gizemli Arkadaş, Hayal Gücü Yüksek Çocuk", // YENİ KİŞİ
        ...
        reversed: {
            ...
            emotion: "Kafa Karışıklığı, Korku, Paranoya", // YENİ ALAN
            situation: "Sezgisel Krizler, Belirsizlik",
            number_rep: "XVIII (18) / Yanılsamalar", archetype: "Kafa Karışıklığı", energy: "Dengesiz Yin",
            person_rep: "Yanılsamalara Kapılan, Paranoyak Düşman, Kararsız Akraba", // YENİ KİŞİ
            astrology: "Balık burcunun Gölgesi"
        }
    },
    // ID 20: GÜNEŞ (The Sun)
    {
        ...
        upright: {
            ...
            emotion: "Neşe, Canlılık, Güven", // YENİ ALAN
            situation: "Başarı, Açıklık, Coşku",
            number_rep: "XIX (19) / Mutluluk, Enerji", archetype: "Canlılık", energy: "Verici (Yang), Pozitif",
            person_rep: "Enerjik Patron, Başarılı Çocuk, Neşeli Arkadaş", // YENİ KİŞİ
        ...
        reversed: {
            ...
            emotion: "Rehavet, Gecikme, Motivasyon Kaybı", // YENİ ALAN
            situation: "Gecikmiş Başarılar, Enerji Düşüklüğü",
            number_rep: "XIX (19) / Gecikme", archetype: "Rehavet", energy: "Dengesiz Yang",
            person_rep: "Motivasyonu Düşük İş Arkadaşı, Rehavete Kapılmış Kuzen", // YENİ KİŞİ
    ...
    // ID 21: HÜKÜM (Judgement)
    {
        ...
        upright: {
            ...
            emotion: "Kabul, Muhasebe, Uyanış", // YENİ ALAN
            situation: "Hesaplaşma, Karar Alma Süreçleri",
            number_rep: "XX (20) / Karar, Hesaplaşma", archetype: "Muhasebe", energy: "Verici (Yang), Uyanış",
            person_rep: "Sorumluluk Alan, Yeniden Doğan Birey, Bilge Yaşlı", // YENİ KİŞİ
        ...
        reversed: {
            ...
            emotion: "Pişmanlık, Reddetme, Tıkanıklık", // YENİ ALAN
            situation: "Kaçırılan Uyanışlar, Hesaplaşma Engeli",
            number_rep: "XX (20) / Reddetme", archetype: "Pişmanlık", energy: "Dengesiz Yang",
            person_rep: "Sorumluluktan Kaçan Akraba, Hatalarından Ders Almayan İş Arkadaşı", // YENİ KİŞİ
    ...
    // ID 22: DÜNYA (The World)
    {
        ...
        upright: {
            ...
            emotion: "Bütünlük, Huzur, Zafer", // YENİ ALAN
            situation: "Tamamlanma, Hedeflere Ulaşma, Döngülerin Kapanması",
            number_rep: "XXI (21) / Tamamlama", archetype: "Bütünlük", energy: "Alıcı-Verici (Yin-Yang)",
            person_rep: "Başarılı Partner, Dünyayı Dolaşan Akraba, Uyumlu Birey", // YENİ KİŞİ
        ...
        reversed: {
            ...
            emotion: "Eksiklik, Gecikme, Hüsran", // YENİ ALAN
            situation: "Gecikmiş Başarı, Tamamlanmamış İşler",
            number_rep: "XXI (21) / Gecikme", archetype: "Eksiklik", energy: "Dengesiz Yin-Yang",
            person_rep: "Hedeflerini Tamamlayamayan, Uyumsuz İş Arkadaşı", // YENİ KİŞİ
            astrology: "Satürn'ün Gölgesi"
        }
    },
    // ID 23: KUPA ASI (Ace of Cups)
    {
        name: "Kupa Ası",
        upright: {
            positive: "Yeni İlişkiler, Duygusal Yenilenme, Sevgi Artışı", negative: "Duygusal Açlık, Aşırı İdealizasyon",
            role: "Sevgiyi Başlatan, İlham Veren", 
            emotion: "Sevgi, Sezgi, Huzur", // YENİ ALAN
            situation: "Yeni Duygusal Başlangıçlar, Kalpten Bağ Kurma",
            number_rep: "As / Duygusal Başlangıç", archetype: "Sezgi", energy: "Alıcı (Yin)",
            person_rep: "Yeni Sevgili/Partner, Sevecen Birey, Empatik Arkadaş", // YENİ KİŞİ
            astrology: "Yengeç burcu"
        },
        reversed: {
            positive: "Duygusal Blokajları Çözme Fırsatı", negative: "Duygusal Kopukluk, Sevgiyi Reddetme",
            role: "Duygularını Açamayan",
            emotion: "Duygusal Açlık, Engellenmişlik, Hayal Kırıklığı", // YENİ ALAN
            situation: "Duygusal Engeller, Sevgi Eksikliği",
            number_rep: "As / Blokaj", archetype: "Duygusal Engeller", energy: "Blokaj",
            person_rep: "İçe Kapanık Ebeveyn, Duygusal Bağ Kuramayan Kişi", // YENİ KİŞİ
            astrology: "Yengeç burcunun Gölgesi"
        }
    },
    // ID 24: KUPA İKİLİSİ (Two of Cups)
    {
        name: "Kupa İkilisi",
        upright: {
            positive: "Sağlıklı İlişkiler, Sevgi ve Uyum", negative: "Dengesizlik, Bağımlılık, Yanlış Anlaşılmalar",
            role: "Partner, Uyum Sağlayıcı", 
            emotion: "Uyum, Karşılıklı Sevgi, Bağlılık", // YENİ ALAN
            situation: "Ortaklıklar, Romantik/İş İlişkilerinde Uyum",
            number_rep: "İki / Birlik, Ortaklık", archetype: "Denge, Uyum", energy: "Alıcı-Verici (Yin-Yang)",
            person_rep: "Anlayışlı Partner, Destekleyici Yakın Arkadaş, İş Ortağı", // YENİ KİŞİ
            astrology: "Yengeç/Boğa Etkisi"
        },
        reversed: {
            positive: "Dengesizliği Fark Edip Güçlendirme", negative: "Uyumsuz İlişkiler, Kopukluk, Çatışma",
            role: "Partneriyle Uyumsuz",
            emotion: "Dengesizlik, Kopukluk, Çatışma", // YENİ ALAN
            situation: "Çatışmalı İlişkiler, Kopukluk",
            number_rep: "İki / Uyumsuzluk", archetype: "Dengesizlik", energy: "Dengesiz Yin-Yang",
            person_rep: "Uyumsuz Partner, Bağımlı Ebeveyn", // YENİ KİŞİ
    ...
    // ID 25: KUPA ÜÇLÜSÜ (Three of Cups)
    {
        name: "Kupa Üçlüsü",
        upright: {
            positive: "Arkadaşlık, Sosyal Bağlar, Kutlama, Mutluluk Paylaşımı", negative: "Aşırı Eğlence, Sorumluluk Eksikliği, Dedikodu",
            role: "Arkadaş, Kutlamacı", 
            emotion: "Neşe, Dostluk, Kutlama", // YENİ ALAN
            situation: "Sosyal Etkinlikler, Kutlamalar",
            number_rep: "Üç / Kutlama, Topluluk", archetype: "Sosyal Bağ", energy: "Verici (Yang), Neşe",
            person_rep: "Neşeli Arkadaş Grubu, Sosyal Akraba, Düğün Organizatörü", // YENİ KİŞİ
            astrology: "Yengeç/Boğa Etkisi"
        },
        reversed: {
            positive: "Sosyal Bağlantıları Yeniden İnşa Etme Fırsatı", negative: "Yalnızlık, Grup Uyumsuzluğu",
            role: "Sosyal İzolasyon Yaşayan",
            emotion: "Yalnızlık, İzolasyon, Uyumsuzluk", // YENİ ALAN
            situation: "Sosyal Kopukluk, Uyumsuz İlişkiler",
            number_rep: "Üç / Yalnızlık", archetype: "İzolasyon", energy: "Dengesiz Yang",
            person_rep: "Sosyal Bağlardan Kopuk Birey, Dedikoducu İş Arkadaşı", // YENİ KİŞİ
            astrology: "Yengeç/Boğa Gölgesi"
        }
    },
    // ID 26: KUPA DÖRTLÜSÜ (Four of Cups)
    {
        name: "Kupa Dörtlüsü",
        upright: {
            positive: "İç Gözlem, Duygusal Yeniden Değerlendirme", negative: "Duygusal Tatminsizlik, Fırsatları Görmeme",
            role: "Düşünen, Durgun", 
            emotion: "Bıkkınlık, Durgunluk, Memnuniyetsizlik", // YENİ ALAN
            situation: "Duygusal Durgunluk, Fırsatları Kaçırma",
            number_rep: "Dört / Durağanlık", archetype: "İçe Dönüş", energy: "Alıcı (Yin)",
            person_rep: "Düşünceli, Pasif Birey, Fırsatları Görmeyen Akraba", // YENİ KİŞİ
            astrology: "Yengeç burcu"
        },
        reversed: {
            positive: "Yeni Duygusal Fırsatlar, Motivasyon", negative: "Durağanlığı Bırakma Zorunluluğu",
            role: "Fırsatları Gören",
            emotion: "Canlanma, Farkındalık, Motivasyon", // YENİ ALAN
            situation: "Duygusal Açılım, Harekete Geçme",
            number_rep: "Dört / Farkındalık", archetype: "Duygusal Açılım", energy: "Dengesiz Yin",
            person_rep: "Farkındalığı Artmış Kişi, Harekete Geçen Arkadaş", // YENİ KİŞİ
            astrology: "Yengeç burcunun Gölgesi"
        }
    },
    // ID 27: KUPA BEŞLİSİ (Five of Cups)
    {
        name: "Kupa Beşlisi",
        upright: {
            positive: "Duygusal Olgunlaşma, Kayıplardan Öğrenme", negative: "Geçmişe Takılma, Hayal Kırıklığı",
            role: "Yas Tutan, Ders Çıkaran", 
            emotion: "Hüzün, Kayıp, Pişmanlık", // YENİ ALAN
            situation: "Duygusal Kayıplar, Hüzün, Ders Çıkarma Süreci",
            number_rep: "Beş / Kayıp, Üzüntü", archetype: "Kayıplardan Ders Çıkarma", energy: "Alıcı (Yin)",
            person_rep: "Duygusal Olarak Hassas Birey, Yas Tutan Arkadaş", // YENİ KİŞİ
            astrology: "Akrep burcu"
        },
        reversed: {
            positive: "İyileşme, Fırsatları Fark Etme, İlerleme", negative: "Geçmişe Dönme Eğilimi",
            role: "Duygusal Olarak Toparlanan",
            emotion: "İyileşme, Kabul, Umut", // YENİ ALAN
            situation: "Duygusal Toparlanma, Geçmişle Yüzleşme",
            number_rep: "Beş / İyileşme", archetype: "Geçmişten Kurtulma", energy: "Dengesiz Yin",
            person_rep: "Duygusal İyileşme Sürecindeki Ebeveyn, İlerleme Kaydeden Kişi", // YENİ KİŞİ
            astrology: "Akrep burcunun Gölgesi"
        }
    },
    // ID 28: KUPA ALTILISI (Six of Cups)
    {
        name: "Kupa Altılısı",
        upright: {
            positive: "Masumiyet, Eski Arkadaşlıklar, Nostalji", negative: "Geçmişe Takılma, Duygusal Saplantı, İlerlemeyi Engelleme",
            role: "Hatırlayan, Paylaşan", 
            emotion: "Nostalji, Huzur, Bağlılık", // YENİ ALAN
            situation: "Eski Anılar, Geçmiş İlişkiler, Duygusal Bağlar",
            number_rep: "Altı / Nostalji", archetype: "Geçmişi Hatırlama", energy: "Alıcı-Verici (Yin-Yang)",
            person_rep: "Çocukluk Arkadaşı, Nostaljik Akraba, Geçmişten Gelen Sevgili/Dost", // YENİ KİŞİ
            astrology: "Boğa burcu (Venüs Etkisi)"
        },
        reversed: {
            positive: "Geçmişi Fark Edip Ders Alma", negative: "Geçmiş Bağımlılığı, Nostaljiye Aşırı Saplanma",
            role: "Geçmişe Saplanan",
            emotion: "Saplantı, Tıkanıklık, Kararsızlık", // YENİ ALAN
            situation: "Duygusal Takılmalar, İlerleyememe",
            number_rep: "Altı / Bağımlılık", archetype: "Geçmişe Takılma", energy: "Dengesiz Yin-Yang",
            person_rep: "Geçmişe Bağlı Ebeveyn, İlerlemeyi Reddeden İş Arkadaşı", // YENİ KİŞİ
            astrology: "Boğa burcunun Gölgesi"
        }
    },
    // ID 29: KUPA YEDİLİSİ (Seven of Cups)
    {
        name: "Kupa Yedilisi",
        upright: {
            positive: "İlham, Hayal Gücü, Yaratıcılık", negative: "Kararsızlık, Yanılsamalar, Gerçeklikten Kopma",
            role: "Hayal Eden, Seçenek Değerlendiren", 
            emotion: "Hayal Gücü, Kafa Karışıklığı, Belirsizlik", // YENİ ALAN
            situation: "Farklı Seçenekler, Karar Verme Süreçleri",
            number_rep: "Yedi / Hayaller, Seçenekler", archetype: "Vizyon", energy: "Alıcı (Yin)",
            person_rep: "Yaratıcı Arkadaş, Kararsız Birey, Hayalperest", // YENİ KİŞİ
            astrology: "Akrep burcu (Plüton Etkisi)"
        },
        reversed: {
            positive: "Yanılsamaları Fark Edip Gerçek Seçenekleri Değerlendirme", negative: "Kararsızlık, Yanlış Seçimler, Yanılsamalara Kapılma",
            role: "Kararsız, Hayal Kırıklığı Yaşayan",
            emotion: "Kararsızlık, Hayal Kırıklığı, Pişmanlık", // YENİ ALAN
            situation: "Yanılsamalar, Karar Alma Zorluğu",
            number_rep: "Yedi / Belirsizlik", archetype: "Kafa Karışıklığı", energy: "Dengesiz Yin",
            person_rep: "Kararsız Partner, Hayal Kırıklığına Uğramış Akraba", // YENİ KİŞİ
            astrology: "Akrep burcunun Gölgesi"
        }
    },
    // ID 30: KUPA SEKİZLİSİ (Eight of Cups)
    {
        name: "Kupa Sekizlisi",
        upright: {
            positive: "Duygusal Olgunlaşma, İçsel Farkındalık, Arayış", negative: "Kaçış, Sorumluluklardan Kaçma, Boşluk Hissi",
            role: "Ayrılan, Arayışta Olan", 
            emotion: "Arayış, Kopuş, Boşluk Hissi", // YENİ ALAN
            situation: "Duygusal Kopuş, Arayış Yolculuğu",
            number_rep: "Sekiz / Ayrılma, Arayış", archetype: "İçsel Farkındalık", energy: "Alıcı (Yin)",
            person_rep: "Münzevi, Duygusal Olarak Olgunlaşan Birey, İlişkiden Ayrılan Partner", // YENİ KİŞİ
            astrology: "Balık burcu (Neptün Etkisi)"
        },
        reversed: {
            positive: "Yeni Yollar Keşfetme Fırsatı", negative: "Duygusal Tıkanıklık, Eski Bağlara Bağlılık",
            role: "Ayrılamayan, Bağlı Kalan",
            emotion: "Tıkanıklık, Bağlılık, Durağanlık", // YENİ ALAN
            situation: "Kopuşu Reddetme, Duygusal Durgunluk",
            number_rep: "Sekiz / Tıkanıklık", archetype: "Duygusal Blok", energy: "Dengesiz Yin",
            person_rep: "Bağlı Kalan Ebeveyn, Arayışını Engelleyen İş Arkadaşı", // YENİ KİŞİ
            astrology: "Balık burcunun Gölgesi"
        }
    },
    // ID 31: KUPA DOKUZLUSU (Nine of Cups)
    {
        name: "Kupa Dokuzlusu",
        upright: {
            positive: "Duygusal ve Maddi Tatmin, Mutluluk, Başarı", negative: "Aşırı Hazcılık, Memnuniyetsizlik",
            role: "Tatmin Olmuş, Mutlu Yaşayan", 
            emotion: "Doyum, Mutluluk, Kendine Güven", // YENİ ALAN
            situation: "Başarı, Keyifli Deneyimler, Duygusal Doyum",
            number_rep: "Dokuz / Tatmin, Doyum", archetype: "Memnuniyet", energy: "Verici (Yang)",
            person_rep: "Tatmin Olmuş Patron, Mutlu Ebeveyn, Keyif Ehli Arkadaş", // YENİ KİŞİ
            astrology: "Balık / Venüs (Duygusal Haz)"
        },
        reversed: {
            positive: "Gerçek Doyumu Bulma Fırsatı", negative: "Hayal Kırıklığı, Tatminsizlik, Aşırı Beklenti",
            role: "Tatmin Olamayan",
            emotion: "Tatminsizlik, Hayal Kırıklığı, Boşluk", // YENİ ALAN
            situation: "Duygusal Eksiklik, Başarıyı Fark Edememe",
            number_rep: "Dokuz / Tatminsizlik", archetype: "Doyumsuzluk", energy: "Dengesiz Yang",
            person_rep: "Duygusal Boşluk Taşıyan Partner, Aşırı Beklentili Kişi", // YENİ KİŞİ
            astrology: "Balık / Venüs Gölgesi"
        }
    },
    // ID 32: KUPA ONLUSU (Ten of Cups)
    {
        name: "Kupa Onlusu",
        upright: {
            positive: "Aile Mutluluğu, Duygusal Bütünlük, Uyum ve Huzur", negative: "İdealizasyon, Uyum Eksikliği",
            role: "Mutlu Aile Bireyi, Duygusal Lider", 
            emotion: "Huzur, Aile Sevgisi, Bütünlük", // YENİ ALAN
            situation: "Aile Mutluluğu, İlişkilerde Tatmin",
            number_rep: "On / Tamamlanma", archetype: "Duygusal Bütünlük", energy: "Alıcı-Verici (Yin-Yang)",
            person_rep: "Mutlu Aile Üyesi, Huzurlu Ebeveyn, Uyumlu Partner", // YENİ KİŞİ
            astrology: "Yay / Balık Etkisi"
        },
        reversed: {
            positive: "Eksiklikleri Fark Edip Uyum Sağlama", negative: "Ailede Çatışma, Duygusal Tatminsizlik",
            role: "Tatminsiz, Uyumsuz",
            emotion: "Uyumsuzluk, Ailevi Hüsran, Huzursuzluk", // YENİ ALAN
            situation: "Duygusal Boşluk, Aile Uyumsuzluğu",
            number_rep: "On / Eksiklik", archetype: "Uyumsuzluk", energy: "Dengesiz Yin-Yang",
            person_rep: "Duygusal Eksiklik Yaşayan Akraba, Uyumsuz Partner", // YENİ KİŞİ
            astrology: "Yay / Balık Gölgesi"
        }
    },
    // ID 33: KUPA UŞAĞI (Page of Cups)
    {
        name: "Kupa Uşağı",
        upright: {
            positive: "Yeni Duygusal Haber, Yaratıcı İlham", negative: "Duygusal Olgunlaşmama, Yüzeysellik",
            role: "Haberci, Öğrenci", 
            emotion: "Merak, Duygusallık, Heyecan", // YENİ ALAN
            situation: "Yeni Duygusal Başlangıç, Yaratıcı Fırsat",
            number_rep: "Uşak / Yeni Haber", archetype: "Duygu", energy: "Pasif",
            person_rep: "Küçük Kız/Oğlan Kardeş, Duygusal Gelişim Gösteren Genç, Yaratıcı Arkadaş", // YENİ KİŞİ
            astrology: "Su Elementi"
        },
        reversed: {
            positive: "İçsel Tıkanıklığı Fark Etme", negative: "Kötü Haber, Hayal Kırıklığı, Kararsızlık",
            role: "Olgunlaşmamış",
            emotion: "Hayal Kırıklığı, Kararsızlık, Olgunlaşmamışlık", // YENİ ALAN
            situation: "Duygusal Blokaj, Yüzeysellik",
            number_rep: "Uşak / Tıkanıklık", archetype: "Tıkanıklık", energy: "Blokaj",
            person_rep: "Kararsız Genç, Olgunlaşmamış Akraba", // YENİ KİŞİ
            astrology: "Su Elementinin Gölgesi"
        }
    },
    // ID 34: KUPA ŞÖVALYESİ (Knight of Cups)
    {
        name: "Kupa Şövalyesi",
        upright: {
            positive: "Romantizm, Duygusal Girişim, İlham", negative: "Duygusal Kararsızlık, Yüzeysellik",
            role: "Romantik, Teklif Eden", 
            emotion: "Aşk, Coşku, Romantizm", // YENİ ALAN
            situation: "Romantik Teklif, Duygusal Yolculuk",
            number_rep: "Şövalye / Duygusal Hareket", archetype: "Romantik Girişim", energy: "Verici (Yang), Hareketli",
            person_rep: "Romantik Partner, Teklif Eden Erkek Arkadaş, İlham Veren İş Arkadaşı", // YENİ KİŞİ
            astrology: "Akrep / Balık Etkisi"
        },
        reversed: {
            positive: "Farkındalık Kazanma ve Fırsatları Değerlendirme", negative: "Hareketsizlik, Duygusal Blokaj, Fırsat Kaçırma",
            role: "Hareketsiz, Romantik Fırsatları Kaçıran",
            emotion: "Duygusal Tıkanıklık, Hayal Kırıklığı, Hareketsizlik", // YENİ ALAN
            situation: "Duygusal Durgunluk",
            number_rep: "Şövalye / Durağanlık", archetype: "Fırsat Kaçırma", energy: "Dengesiz Yang",
            person_rep: "Hareketsiz veya Fırsatları Değerlendiremeyen Partner", // YENİ KİŞİ
            astrology: "Akrep / Balık Gölgesi"
        }
    },
    // ID 35: KUPA KRALİÇESİ (Queen of Cups)
    {
        name: "Kupa Kraliçesi",
        upright: {
            positive: "Duygusal Olgunluk, Sezgi, Empati ve Şefkat", negative: "Aşırı Duygusallık, Bağımlılık, Savunmasızlık",
            role: "Şefkatli, Empatik Lider", 
            emotion: "Empati, Şefkat, Sezgisellik", // YENİ ALAN
            situation: "Empatik İlişkiler, Sezgisel Farkındalık",
            number_rep: "Kraliçe / Sezgi, Şefkat", archetype: "Duygusal Denge", energy: "Alıcı (Yin)",
            person_rep: "Anne, Kız Kardeş, Sezgisi Güçlü Kadın, Empatik Yönetici", // YENİ KİŞİ
            astrology: "Yengeç burcu"
        },
        reversed: {
            positive: "Dengesizlik Fark Edilip Olgunluk Kazanma", negative: "Duygusal Blokaj, Aşırı Savunmasızlık, Sezgi Kaybı",
            role: "Duygusal Olarak Dengesiz",
            emotion: "Dengesizlik, Aşırı Duygusallık, Savunmasızlık", // YENİ ALAN
            situation: "Duygusal Dengesizlik, Çatışmalar",
            number_rep: "Kraliçe / Dengesizlik", archetype: "Sezgi Kaybı", energy: "Dengesiz Yin",
            person_rep: "Duygusal Olarak Dengesiz Ebeveyn, Bağımlı Partner", // YENİ KİŞİ
            astrology: "Yengeç burcunun Gölgesi"
        }
    },
    // ID 36: KUPA KRALI (King of Cups)
    {
        name: "Kupa Kralı",
        upright: {
            positive: "Duygusal Liderlik, Bilgelik, Destek", negative: "Duygusal Dengesizlik, Sertlik",
            role: "Olgun Lider", 
            emotion: "Bilgelik, Destek, Sakinlik", // YENİ ALAN
            situation: "Empatik Rehberlik",
            number_rep: "Kral / Liderlik", archetype: "Denge", energy: "Yin-Yang",
            person_rep: "Baba, Olgun Lider, Empatik Patron, Akıl Hocası", // YENİ KİŞİ
            astrology: "Yengeç / Balık Etkisi"
        },
        reversed: {
            positive: "Dengesizliği Fark Etme", negative: "Duygusal Blokaj, Soğukluk, Kontrolcülük",
            role: "Dengesiz, Soğuk",
            emotion: "Soğukluk, Kontrolcülük, Tıkanıklık", // YENİ ALAN
            situation: "Duygusal Tıkanıklık",
            number_rep: "Kral / Blokaj", archetype: "Kontrol", energy: "Blokaj",
            person_rep: "Kontrolcü Baba, Soğuk Patron, Duygusal Bağ Kuramayan Kişi", // YENİ KİŞİ
            astrology: "Yengeç / Balık Gölgesi"
        }
    },
    
    // ID 37-50: KILIÇLAR SİLSİLESİ (DÜZENLENDİ)
    ...
    // ID 51-64: DEĞNEKLER SİLSİLESİ (DÜZENLENDİ)
    ...
    // ID 65-78: TILSIMLAR SİLSİLESİ (DÜZENLENDİ)
...
// ... (Geriye kalan sunucu mantığı ve rotaları aynı kalır)
...
// MÜŞTERİ KULLANICI YÖNETİMİ (Kayıt/Giriş) - AYNI
...
// YÖNETİCİ GİRİŞİ (Kullanıcı Adı ile) - AYNI
...
// Socket.IO bağlantılarını dinle (Gerçek zamanlı iletişim) - AYNI
io.on('connection', (socket) => {
    ...
    socket.on('card_selected', (data) => {
        ...
        const { cardName, imagePath, meaningCategories, position } = getCardDataById(cardId); 
...
http.listen(PORT, () => {
    ...
    console.log(`Kullanıcı Uygulaması (Link): http://localhost:${PORT}/index.html`);
    console.log(`Tarot Bakıcısı Paneli: http://localhost:3000/reader_panel.html`);
});